...
Puzzle.prototype.InitModels = function() {
  ...
  // Faces
  model.AddOutTriangle(0,2,1); // Top
  model.AddOutTriangle(0,5,1); //
  model.AddOutTriangle(1,4,2); //
  model.AddOutTriangle(2,3,0); //
  model.AddInTriangle(3,5,4); // Bottom
  model.AddInTriangle(0,3,5); // 
  model.AddInTriangle(1,5,4); // 
  model.AddInTriangle(2,4,3); // 
  model.InitBuffers();
