...
function InitMoves() {
    ...
    MOVES[0].Permutation = [3,0,1,2, 4, 8,5,6,7];
    ...
    MOVES[1].Permutation = [1,2,3,0, 4, 6,7,8,5];
    ...
    MOVES[2].Permutation = [3,0,1,2, 4, 8,5,6,7];
    ...
    MOVES[3].Permutation = [1,2,3,0, 4, 6,7,8,5];
    ...
    MOVES[4].PiecePairs.push([EDGES,11]);
    MOVES[4].Permutation = [3,0,1,2, 4, 8,5,6,7];
    ...
    MOVES[5].PiecePairs.push([EDGES,11]);
    MOVES[5].Permutation = [1,2,3,0, 4, 6,7,8,5];
    ...
    MOVES[6].Permutation = [3,0,1,2, 4, 8,5,6,7];
    ...
    MOVES[7].Permutation = [1,2,3,0, 4, 6,7,8,5];
    ...
    MOVES[8].PiecePairs.push([CENTERS,4]);
    MOVES[8].PiecePairs.push([EDGES,6]);
    MOVES[8].PiecePairs.push([EDGES,9]);
    MOVES[8].PiecePairs.push([EDGES,7]);
    MOVES[8].PiecePairs.push([EDGES,10]);
    MOVES[8].Permutation = [3,0,1,2, 4, 8,5,6,7];
    ...
    MOVES[9].PiecePairs.push([CENTERS,4]);
    MOVES[9].PiecePairs.push([EDGES,6]);
    MOVES[9].PiecePairs.push([EDGES,9]);
    MOVES[9].PiecePairs.push([EDGES,7]);
    MOVES[9].PiecePairs.push([EDGES,10]);
    MOVES[9].Permutation = [1,2,3,0, 4, 6,7,8,5];
    ...
    MOVES[12].PiecePairs.push([EDGES,8]);
    MOVES[12].PiecePairs.push([EDGES,11]);
    MOVES[12].PiecePairs.push([EDGES,10]);
    MOVES[12].PiecePairs.push([EDGES,9]);
    MOVES[12].Permutation = [3,0,1,2, 7,4,5,6];
    ...
    MOVES[13].PiecePairs.push([EDGES,8]);
    MOVES[13].PiecePairs.push([EDGES,11]);
    MOVES[13].PiecePairs.push([EDGES,10]);
    MOVES[13].PiecePairs.push([EDGES,9]);
    MOVES[13].Permutation = [1,2,3,0, 5,6,7,4];
    ...
    MOVES[14].PiecePairs.push([CENTERS,4]);
    ...
    MOVES[14].Permutation = [3,0,1,2, 7,4,5,6];
    ...
    MOVES[15].PiecePairs.push([CENTERS,4]);
    ...
    MOVES[15].Permutation = [1,2,3,0, 5,6,7,4];
    ...
    MOVES[16].PiecePairs.push([CENTERS,2]);
    MOVES[16].PiecePairs.push([CENTERS,1]);
    ...
    MOVES[16].Permutation = [3,0,1,2, 7,4,5,6];

    MOVES[17] = new Move();
    MOVES[17].Axis = [0,0,1];
    MOVES[17].EndAngle = -90.0;
    MOVES[17].PiecePairs.push([CENTERS,0]);
    MOVES[17].PiecePairs.push([CENTERS,2]);
    ...
    MOVES[17].Permutation = [1,2,3,0, 5,6,7,4];
